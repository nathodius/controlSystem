...
{
    /* Initialize USART */
    PLIB_USART_BaudRateSet(USART_ID_4, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_1), 57600);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_UART4, INT_PRIORITY_LEVEL1);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_UART4, INT_SUBPRIORITY_LEVEL0);
